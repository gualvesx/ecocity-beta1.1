        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-xl overflow-hidden shadow-xl border-4 border-white relative animate-fade-in-up">
            <div className="aspect-[4/3] bg-eco-blue-light relative overflow-hidden">
              ...
              {/* Map Points */}
              <div className="absolute top-1/4 left-1/4 w-8 h-8 rounded-full bg-eco-green shadow-lg border-2 border-white animate-pulse-gentle"></div>
              <div className="absolute top-1/2 left-2/3 w-8 h-8 rounded-full bg-eco-brown shadow-lg border-2 border-white animate-pulse-gentle" style={{ animationDelay: "0.5s" }}></div>
              <div className="absolute top-3/4 left-1/3 w-8 h-8 rounded-full bg-eco-blue shadow-lg border-2 border-white animate-pulse-gentle" style={{ animationDelay: "1s" }}></div>
            </div>
