  ...
  return (
    <section className="py-16 bg-white dark:bg-gray-900">
      <div className="container px-4 md:px-6">
        ...
        <div className="mb-16 overflow-hidden bg-eco-green rounded-xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            <div className="p-8 md:p-10 flex flex-col justify-center">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">Ajude Sua Cidade a se Tornar mais Verde</h3>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/70">Árvores Plantadas</div>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white mr-3">
                  ...
                  <div>
                    <div className="font-semibold text-white">743kg</div>
                    <div className="text-sm text-white/70">Resíduos Reciclados</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative">
              <AspectRatio ratio={4/3} className="md:h-full">
                <div className="absolute inset-0 bg-gradient-to-r from-eco-green/40 to-eco-green-dark/40 z-10"></div>
